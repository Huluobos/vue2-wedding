<template>
  <div class="box-container">
    ...
    <router-view @playAudio="playAudio">></router-view>
  </div>
</template>
<script>
...
.box-container{
  width: 100vw;
  background: url("../assets/bg1.gif") repeat center center fixed;
